# Terms of Service for PriceAnalysis
...
By downloading, installing, or using the PriceAnalysis mobile application (the "App"), you agree to be bound by these Terms of Service ("Terms"). If you do not agree to these Terms, please do not use the App.

## Description of Service

PriceAnalysis is a mobile application that provides:
- Price tracking and analysis for PriceSmart products
- Historical price trends and analytics
- Product search and filtering capabilities
- Price change notifications
- Category and brand analysis
- Daily price analysis reports
...
### Our Rights
- The App, including its design, code, features, and content, is owned by Surenjanath Singh
...
- You grant us a license to use any feedback or suggestions you provide
...
### Data Limitations
- Prices and product information may change without notice
- Product availability may not be real-time
- Some products may be temporarily unavailable or discontinued
...
- WE SHALL NOT BE LIABLE FOR ANY LOSS OF PROFITS, DATA, OR USE
...
- We are not responsible for price discrepancies between the App and actual store prices
- We are not responsible for product availability or stock status
- We are not responsible for any financial losses resulting from use of the App

## Indemnification

You agree to indemnify, defend, and hold harmless Surenjanath Singh and any affiliates from and against any claims, damages, losses, liabilities, and expenses (including legal fees) arising from:
- Your use of the App
...
- For major changes, we may provide additional notification
...
- Any reason we deem necessary to protect our rights or the rights of others
...
These Terms shall be governed by and construed in accordance with the laws of the jurisdiction where the developer is located, without regard to its conflict of law provisions.
...
### Formal Resolution
- If informal resolution fails, disputes will be resolved through binding arbitration or in a court of competent jurisdiction
...
Our failure to enforce any right or provision of these Terms will not be considered a waiver of those rights. If we waive any provision, it will only be in writing and signed by us.
...
By using the PriceAnalysis app, you acknowledge that you have read, understood, and agree to be bound by these Terms of Service.
